...
var AppComponent = /** @class */ (function () {
    ...
    Object.defineProperty(AppComponent.prototype, "activeMenu", {
        get: function () {
    ...
    Object.defineProperty(AppComponent.prototype, "count", {
        get: function () {
    ...
    Object.defineProperty(AppComponent.prototype, "isDark", {
        get: function () {
            return this.store.select(_shared_ngrx_selectors_chat_selector__WEBPACK_IMPORTED_MODULE_3__["getConfig"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (config) { return config.themeDark; }));
        },
        enumerable: true,
        configurable: true
    });
    AppComponent.prototype.disconnect = function () {
        ...
        this.store
            ...
            _this.store.dispatch(new _shared_ngrx_actions_chat_action__WEBPACK_IMPORTED_MODULE_4__["UpdateConfig"](tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, config, { username: "" })));
        });
...
/* harmony import */ var ngx_linkifyjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-linkifyjs */ "./node_modules/ngx-linkifyjs/esm5/ngx-linkifyjs.es5.js");
...
/* harmony import */ var _ctrl_ngx_emoji_mart__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @ctrl/ngx-emoji-mart */ "./node_modules/@ctrl/ngx-emoji-mart/fesm5/ctrl-ngx-emoji-mart.js");
...
var ChatComponent = /** @class */ (function () {
    function ChatComponent(store, action$, embedService) {
        this.store = store;
        this.action$ = action$;
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        this.action$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_shared_ngrx_actions_chat_action__WEBPACK_IMPORTED_MODULE_8__["ActionTypes"].ADD_MESSAGE), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(function () { return (_this.isLoading = true); }));
        this.action$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_3__["ofType"])(_shared_ngrx_actions_chat_action__WEBPACK_IMPORTED_MODULE_8__["ActionTypes"].ADD_MESSAGE_SUCCESS), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(function () { return (_this.isLoading = false); }));
    };
    ChatComponent.prototype.onScroll = function ($event) {
    ...
    Object.defineProperty(ChatComponent.prototype, "messages", {
        get: function () {
            var _this = this;
            return this.store.select(_shared_ngrx_selectors_chat_selector__WEBPACK_IMPORTED_MODULE_9__["messages"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(function (messages) {
                var completeForeach = function () {
                    if (!_this.firstInitMessages) {
                        setTimeout(function () {
                            _this.boxScroll.scrollTop = _this.boxScroll.scrollHeight;
                        });
                        _this.firstInitMessages = !_this.firstInitMessages;
                        _this.store.dispatch(new _shared_ngrx_actions_chat_action__WEBPACK_IMPORTED_MODULE_8__["UpdateMessage"]());
                    }
                };
    ...
    ChatComponent.prototype.sendMessage = function ($event) {
        ...
        var send = function () {
            var usernameStoreSubscription = _this.usernameStore.subscribe(function (name) {
                _this.store.dispatch(new _shared_ngrx_actions_chat_action__WEBPACK_IMPORTED_MODULE_8__["AddMessage"]({
                    name: name,
                    description: _this.message.value
                }));
            });
            _this.message.setValue("");
            _this.subscription.push(usernameStoreSubscription);
        };
        if ($event != null) {
            var getConfigSubscription = this.store
    ...
    Object.defineProperty(ChatComponent.prototype, "usernameStore", {
        get: function () {
    ...
    Object.defineProperty(ChatComponent.prototype, "isDark", {
        get: function () {
            return this.store.select(_shared_ngrx_selectors_chat_selector__WEBPACK_IMPORTED_MODULE_9__["getConfig"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (config) { return config.themeDark; }));
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ChatComponent.prototype, "isShorcut", {
        get: function () {
            return this.store
                .select(_shared_ngrx_selectors_chat_selector__WEBPACK_IMPORTED_MODULE_9__["getConfig"])
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (config) { return config.shortcutEnter; }));
        },
        enumerable: true,
        configurable: true
    });
    ChatComponent.prototype.isEmbedVideo = function (texte) {
        return this.regexYoutube.test(texte);
    };
    ChatComponent.prototype.embedVideo = function (texte) {
        return this.embedService.embed(texte, { image: "thumbnail_medium" });
    };
    ChatComponent.prototype.toggleSmiley = function () {
        this.openSmiley = !this.openSmiley;
    };
    ChatComponent.prototype.formatDateAMPM = function (date) {
        return this.store.select(_shared_ngrx_selectors_chat_selector__WEBPACK_IMPORTED_MODULE_9__["getConfig"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (config) {
    ...
    ChatComponent.prototype.ngOnDestroy = function () {
        this.subscription.forEach(function (subscription) { return subscription.unsubscribe(); });
    };
...
var IsExistName = /** @class */ (function () {
    function IsExistName(store, router) {
        this.store = store;
        this.router = router;
    }
    IsExistName.prototype.canActivate = function (route, state) {
        var _this = this;
        return this.store.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
            _this.store
                .select(_shared_ngrx_selectors_chat_selector__WEBPACK_IMPORTED_MODULE_7__["isLoadConfig"])
                .subscribe(function (isLoad) {
                if (!isLoad) {
                    _this.store.dispatch(new _shared_ngrx_actions_chat_action__WEBPACK_IMPORTED_MODULE_6__["Load"]());
                }
            });
        }), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_3__["select"])(_shared_ngrx_selectors_chat_selector__WEBPACK_IMPORTED_MODULE_7__["isLogin"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])(function (isLogin) {
            if (isLogin) {
                if (state.url === "/login") {
    ...
    IsExistName.ctorParameters = function () { return [
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        var _this = this;
        var selectConfig = this.store.select(_shared_ngrx_selectors_chat_selector__WEBPACK_IMPORTED_MODULE_7__["getConfig"]).subscribe(function (config) {
            if (config.username != '') {
    ...
    LoginComponent.prototype.sendUsername = function () {
        if (this.username.valid) {
            var value = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _shared_ngrx_reducers_chat_reducers__WEBPACK_IMPORTED_MODULE_4__["initialState"].config, { username: this.username.value });
...
var SettingsComponent = /** @class */ (function () {
    ...
    SettingsComponent.prototype.ngOnInit = function () {
        var _this = this;
        var getConfigSubscription = this.store.select(_shared_ngrx_selectors_chat_selector__WEBPACK_IMPORTED_MODULE_4__["getConfig"]).subscribe(function (config) {
            _this.settings.setValue(config, { emitEvent: false });
        });
        var settingsChangeSubscription = this.settings.valueChanges.subscribe(function (value) {
            var configState = {
            ...
            _this.store.dispatch(new _shared_ngrx_actions_chat_action__WEBPACK_IMPORTED_MODULE_5__["UpdateConfig"](configState));
        });
        this.subscription.push(getConfigSubscription, settingsChangeSubscription);
    };
    SettingsComponent.prototype.isActive = function (value, nameFormControl) {
        return this.settings.get(nameFormControl).value == value;
    };
    Object.defineProperty(SettingsComponent.prototype, "isDark", {
        get: function () {
            return this.store.select(_shared_ngrx_selectors_chat_selector__WEBPACK_IMPORTED_MODULE_4__["getConfig"]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (config) { return config.themeDark; }));
        },
        enumerable: true,
        configurable: true
    });
 ...
 * @class  StartSuccess
 */
var StartSuccess = /** @class */ (function () {
    /**
     * Create a Action Start.
     * @param {messages} Message[] - The Array of Message.
     */
    function StartSuccess(messages) {
        this.messages = messages;
        this.type = ActionTypes.START_APP_SUCCESS;
    }
    StartSuccess.ctorParameters = function () { return [
        { type: Array }
    ]; };
    return StartSuccess;
}());
...
var AddMessage = /** @class */ (function () {
    ...
    AddMessage.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return AddMessage;
}());

var AddMessageSuccess = /** @class */ (function () {
    function AddMessageSuccess(message) {
        this.message = message;
        this.type = ActionTypes.ADD_MESSAGE_SUCCESS;
    }
    AddMessageSuccess.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return AddMessageSuccess;
}());

var UpdateMessage = /** @class */ (function () {
...
var UpdateConfig = /** @class */ (function () {
    ...
    UpdateConfig.ctorParameters = function () { return [
        { type: undefined }
    ]; };
    return UpdateConfig;
}());

var UpdateConfigSuccess = /** @class */ (function () {
    function UpdateConfigSuccess(config) {
        this.config = config;
        this.type = ActionTypes.UPDATE_CONFIG_SUCCESS;
    }
    UpdateConfigSuccess.ctorParameters = function () { return [
        { type: undefined }
    ]; };
...
var ChatEffects = /** @class */ (function () {
    function ChatEffects(lsStorage, toastr, actions, chatService) {
        ...
        this.$addMessage = this.actions.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_chat_action__WEBPACK_IMPORTED_MODULE_5__["ActionTypes"].ADD_MESSAGE), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
            _this.chatService.sendMessage(data.message);
        }));
        this.$receiveMessage = this.chatService.getNewMessage().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
            return new _actions_chat_action__WEBPACK_IMPORTED_MODULE_5__["AddMessageSuccess"](data);
        }));
        this.$config = this.actions.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["ofType"])(_actions_chat_action__WEBPACK_IMPORTED_MODULE_5__["ActionTypes"].UPDATE_CONFIG), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (action) {
            var configChange = [];
            var getConfig = _this.lsStorage.getConfig();
            var newConfig = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, getConfig, action.config);
            _this.lsStorage.setConfig(newConfig);
            for (var property in getConfig) {
                if (getConfig[property] != newConfig[property]) {
                    configChange.push(property);
                }
            }
            var toastrMessange = function () {
                _this.toastr.success("Success Change", "Update Settings - " + configChange.join(","), { timeOut: 3000 });
            };
    ...
    ChatEffects.ctorParameters = function () { return [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _actions_chat_action__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../actions/chat.action */ "./src/app/shared/ngrx/actions/chat.action.ts");
...
function ChatReducer(state, action) {
    ...
    switch (action.type) {
        case _actions_chat_action__WEBPACK_IMPORTED_MODULE_1__["ActionTypes"].LOAD_CONFIG_SUCCESS:
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { config: action.state, isLoadConfig: true });
        case _actions_chat_action__WEBPACK_IMPORTED_MODULE_1__["ActionTypes"].START_APP_SUCCESS:
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { messages: action.messages.map(function (message) {
                    message.read = false;
                    return message;
                }) });
        case _actions_chat_action__WEBPACK_IMPORTED_MODULE_1__["ActionTypes"].ADD_MESSAGE_SUCCESS:
            action.message.read = false;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { messages: state.messages.concat([action.message]), countNotRead: state.messages.concat([action.message]).filter(function (message) { return message.read === false; }).length });
        case _actions_chat_action__WEBPACK_IMPORTED_MODULE_1__["ActionTypes"].UPDATE_MESSAGE:
            var newStates = state.messages.map(function (message) {
                message.read = true;
                return message;
            });
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { messages: newStates, countNotRead: newStates.filter(function (message) { return message.read == false; }).length });
        case _actions_chat_action__WEBPACK_IMPORTED_MODULE_1__["ActionTypes"].UPDATE_CONFIG_SUCCESS:
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state, { config: action.config });
        default:
            return state;
    }
}
...
var getChatState = function (state) { return state.ChatReducer; };
var getConfig = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getChatState, function (state) { return state && state.config ? state.config : null; });
var isLogin = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getChatState, function (state) { return state && state.config && state.config.username && state.config.username != "" ? true : false; });
var isLoadConfig = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getChatState, function (state) { return state && state.isLoadConfig; });
var username = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getChatState, function (state) { return state && state.config && state.config.username ? state.config.username : undefined; });
var messages = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getChatState, function (state) { return state && state.messages ? state.messages : []; });
var count = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(getChatState, function (state) { return state && state.countNotRead ? state.countNotRead : 0; });
...
var ChatService = /** @class */ (function () {
    ...
    Object.defineProperty(ChatService.prototype, "socket", {
        get: function () {
            return this._socket;
        },
        enumerable: true,
    ...
    ChatService.prototype.getAllMessage = function () {
        var _this = this;
        return rxjs__WEBPACK_IMPORTED_MODULE_1__["Observable"].create(function (observer) {
...
var SessionstorageService = /** @class */ (function () {
    ...
    SessionstorageService.prototype.getConfig = function () {
    ...
    SessionstorageService.prototype.setConfig = function (newConfig) {
